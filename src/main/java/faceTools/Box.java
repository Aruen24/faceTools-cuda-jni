...
//    }
    ...
    public void calAngles() {
        ...
        int x1 = (int)landmark[0];
        int y1 = (int)landmark[1];

        // right eye
        int x2 = (int)landmark[2];
        int y2 = (int)landmark[3];

        // nose
        int x3 = (int)landmark[4];
        int y3 = (int)landmark[5];

        // left side of mouth
        int x4 = (int)landmark[6];
        int y4 = (int)landmark[7];

        // right side of mouth
        int x5 = (int)landmark[8];
        int y5 = (int)landmark[9];
